...
class EmbeddingEvaluator:
    def __init__(self, model_name):
        assert model_name in [
            ...
            "GanjinZero/BioBART-Base" ## added for local testing #######@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ but the challenge will use aaditya/Llama3-OpenBioLLM-8B for score calculation
...
class REG_Evaluator:
    def __init__(self, embedding_model, spacy_model='en_core_sci_md', api_key=None): 
